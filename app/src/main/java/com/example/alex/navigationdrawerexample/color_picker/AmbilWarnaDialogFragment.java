package com.example.alex.navigationdrawerexample.color_picker;
...
public class AmbilWarnaDialogFragment extends DialogFragment implements View.OnTouchListener, View.OnClickListener {
    ...
    private int mColor;
        ...
        public static int positionOfSpinner=-1;
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mParentView = inflater.inflate(R.layout.ambilwarna_dialog, container, true);
